 ...
 * @brief syscall number to string
 * @version alpha-1.0.0
 * @date 2026-06-21
 *
...
__ATTR_ALWAYS_INLINE__ static const char* syscall_to_string(int num) {
    switch (num) {
        ...
        case __NR_set_mempolicy_home_node: return "set_mempolicy_home_node";
        case __NR_cachestat:               return "cachestat";
        case __NR_fchmodat2:               return "fchmodat2";
        case __NR_map_shadow_stack:        return "map_shadow_stack";
        case __NR_futex_wake:              return "futex_wake";
        case __NR_futex_wait:              return "futex_wait";
        case __NR_futex_requeue:           return "futex_requeue";
        case __NR_statmount:               return "statmount";
        case __NR_listmount:               return "listmount";
        case __NR_lsm_get_self_attr:       return "lsm_get_self_attr";
        case __NR_lsm_set_self_attr:       return "lsm_set_self_attr";
        case __NR_lsm_list_modules:        return "lsm_list_modules";
        case __NR_mseal:                   return "mseal";
        case __NR_setxattrat:              return "setxattrat";
        case __NR_getxattrat:              return "getxattrat";
        case __NR_listxattrat:             return "listxattrat";
        case __NR_removexattrat:           return "removexattrat";
        case __NR_open_tree_attr:          return "open_tree_attr";
        case __NR_file_getattr:            return "file_getattr";
        case __NR_file_setattr:            return "file_setattr";
        case __NR_listns:                  return "listns";
